    ...
    projects: [
      {
        ...
        descriptions: [
          ...
          },
          {
            ...
            desc: [
              'pc, mobile 마크업이 분리되어 있어 같은 컨텐츠를 2번 삽입/검수해야 하는 케이스들 pc 소스 기준으로 mobile 소스 자동 삽입',
            ]
          },
          {
            title: '[개선] 차량 상세 페이지 - 전시 차량 조회 연동',
            desc: [
              '해당 전시 차량 조회 기능 추가'
            ]
          },
      ...
      },
      {
        ...
        descriptions: [
          ...
          '<a href="https://www.sony.co.kr/alpha/handler/alphaCommon-Start?PageName=jsp/alpha/gmaster/gallery.jsp" target="_blank" title="새창">갤러리 페이지 내 사진 자세히 보기 팝업(PC)</a> 세로형 디자인 > 가로형으로 제안하여 작업 진행',
        ],
        keywords: [
          'jQuery',
          'HTML/CSS',
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        type: '구축',
        descriptions: [
          '기획부터 사이트 제작에 필요한 직원들 사진 촬영, 디자인, 퍼블리싱까지 모두 진행했던 1인 프로젝트',
        ],
        keywords: [
          'jQuery',
          'HTML/CSS',
