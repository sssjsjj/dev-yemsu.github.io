    ...
    projects: [
      {
        ...
        descriptions: [
          ...
          '신규 차량 런칭 / 사이트 유지보수 및 개선 (스크립트 작업 위주)',
          '웹 접근성 인증 갱신 작업',
          '[운영 외] 차량 상세 페이지 개편 작업',
          '[운영 외] static html 단순 작업 자동화'
        ],
        keywords: [
          'HTML',
          'SCSS',
      ...
      },
      {
        ...
        descriptions: [
          ...
          '인도 개발자와 협업',
          '[운영 외] 컨텐츠 상세 페이지 개편 독일 디자인 업체와 협업',
          '[운영 외] 현대 월드와이드 타 업체 개편 이후 WWN3.0 사이트 확산 작업',
        ],
        keywords: [
          'HTML',
          'SCSS',
      ...
      },
      {
        ...
        descriptions: [
          '사이트 유지보수 및 개선',
          '정기 이벤트 페이지 작업',
          '개발 서버 존재하지 않아 회사 호스트에 작업 파일 업로드하여 검수용 url 생성',
          '보안 문제로 개발에서만 배포 진행 가능하여 작업 파일 및 내용 정리하여 개발에 전달',
          '웹 접근성 인증 갱신 작업',
        ],
        keywords: [
          'HTML',
      ...
      },
      {
        ...
        descriptions: [
          ...
          'Parallax, animation 등 스크롤 이벤트에 따른 효과',
          '플러그인 없이 기능 구현'
        ],
        keywords: [
          'HTML',
      ...
      },
      {
        ...
        descriptions: [
          '사이트 유지보수 및 개선',
          'AEM(Adobe Experience Manager) - 미쟝센 제외',
          '정기 상품 상세 업데이트, 이벤트 페이지 작업',
          '웹 접근성 인증 갱신 작업',
          '[운영 외] 설화수 스파 예약 시스템 개선',
          '[운영 외] 미쟝센 신규 이벤트 페이지 작업',
          '[운영 외] 마몽드 상품 상세페이지 개선 작업',
          '담당 업체 변경되면서 인수인계 문서 작성 및 외부 회의 참여',
        ],
        keywords: [
          'HTML',
          'CSS',
